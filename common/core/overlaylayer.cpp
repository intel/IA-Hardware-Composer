...
void OverlayLayer::InitializeState(HwcLayer* layer,
  ...
  if (display_frame_.right < right_constraint) {
    display_frame_.right = std::max(display_frame_.left, display_frame_.right);
  }
  ...
  surface_damage_.bottom =
      std::min(surface_damage_.bottom, display_frame_.bottom);
  ETRACE("Layer2 %d %d %d %d \n", display_frame_.left, display_frame_.right,
         display_frame_.top, display_frame_.bottom);
  ...
  if (lconstraint >= 0 && rconstraint >= 0) {
    ETRACE("SOurce %f %f %f %f \n", source_crop_.left, source_crop_.right,
           source_crop_.top, source_crop_.bottom);
    ...
    ETRACE("Layer2 source_crop_ %f %f %f %f \n", source_crop_.left,
           source_crop_.right, source_crop_.top, source_crop_.bottom);
  }
}
