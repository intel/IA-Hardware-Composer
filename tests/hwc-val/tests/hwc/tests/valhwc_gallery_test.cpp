...
/** \addtogroup HwcTestGallery Gallery
...
int HwcTestTest::Run(void) {
  SurfaceSender::SurfaceSenderProperties sSSP1(
      SurfaceSender::epsGallerySurface);
  CreateSurface(sSSP1);

  SurfaceSender::SurfaceSenderProperties sSSP2(SurfaceSender::epsGalleryUI);
  CreateSurface(sSSP2);

  SurfaceSender::SurfaceSenderProperties sSSP3(SurfaceSender::epsNavigationBar);
  CreateSurface(sSSP3);

  SurfaceSender::SurfaceSenderProperties sSSP4(SurfaceSender::epsMenu);
  CreateSurface(sSSP4);
