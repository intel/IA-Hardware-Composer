...
static CCTest tests[] = {
    ...
    {{{13, 14}, {10, 11}, {22, 23}, {19, 20}, {16, 17}, {-1}},
     -1,
     {{10, 11}, {13, 14}, {16, 17}, {19, 20}, {22, 23}, {-1}}},
    ...
    {{{13, 14}, {10, 11}, {22, 23}, {19, 20}, {16, 17}, {5, 25}, {-1}},
     -1,
     {{5, 25}, {-1}}},

    {{{13, 14}, {10, 11}, {22, 23}, {19, 20}, {16, 17}, {12, 21}, {-1}},
     -1,
     {{10, 23}, {-1}}},
...
// Helpers to make templated CorrectCC work with both CharClass and
// CharClassBuilder.
...
bool CorrectCC(CharClass* cc, CCTest* t, const char* desc) {
  ...
  for (int j = 0; t->final[j].lo >= 0; j++, ++it) {
    if (it == cc->end() || it->lo != t->final[j].lo ||
        it->hi != t->final[j].hi) {
      Broke(desc, t, cc);
      return false;
    }
