...
HWC2::Error DrmHwcTwo::HwcDisplay::PresentDisplay(int32_t *retire_fence) {
  ...
  *retire_fence = -1;
  ...
  // into the display has suspended and remain in the low power state and continue
  // displaying the current state and stop applying display update from the client
...
HWC2::Error DrmHwcTwo::HwcDisplay::SetPowerMode(int32_t mode_in) {
  ...
  display_->SetDpmsMode(power_mode);
